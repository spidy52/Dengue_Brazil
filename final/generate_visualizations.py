...
def generate_visualizations():
    ...
    for zone in range(1, 7):
        ...
        # Validation Buffer (June 2024 - Dec 2025) seamlessly connected to last_dt
        ...
        # Forecast Horizon (2026 - 2030) seamlessly connected to last buffer point
        ...
        # Section 2: Validation Buffer (Seamless)
        ...
        fig.savefig(f"{out_dir_5yr}/dengue_forecast_zone_{zone}.png", dpi=600)
        plt.close()
    ...
    plt.savefig("figures/dengue_forecast_combined_zones_5years.eps", format="eps")
    plt.savefig(f"{out_dir_5yr}/dengue_forecast_combined_zones_5years.eps", format="eps")
    ...
    plt.savefig("figures/dengue_forecast_combined_zones_5years.png", dpi=600)
    plt.savefig(f"{out_dir_5yr}/dengue_forecast_combined_zones_5years.png", dpi=600)
    plt.close()
